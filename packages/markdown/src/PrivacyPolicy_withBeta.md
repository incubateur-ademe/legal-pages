...
- les Données à caractère personnel sont traitées de manière licite, loyale et
...
- données de contact : numéro de téléphone fixe ou portable, adresse postale,
adresse email.
...
- En se fondant sur le consentement des Personnes concernées, l’ADEME met en œuvre des Traitements poursuivant les finalités suivantes :
    - la fourniture de Services personnalisés, tels que des annonces, newsletters,
    formations, etc. ;
    - la fourniture de Services facultatifs tels que les espaces de discussion
    interactifs ou tchats ;
...
- En se fondant sur ses intérêts légitimes, l’ADEME met en œuvre des Traitements poursuivant les finalités suivantes :
    ...
    - la réalisation d’opérations de prospection commerciale à destination des
    professionnels ;
    - la gestion des clients ou des employés au sein d’un groupe
    d’entreprises à des fins de gestion administrative interne ;
...
*ou par Email à l’adresse suivante : [rgpd@ademe.fr](mailto:rgpd@ademe.fr)*
...
En cas de violation de la réglementation applicable en matière de protection des Données à caractère personnel, les Personnes concernées disposent également d’un droit de réclamation auprès de la Commission nationale de l’informatique et des libertés sur le
territoire français :
