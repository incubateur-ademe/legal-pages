...
Sauf mention contraire précisée sur le fichier <a href="{{licenceUrl}}" target="_blank">{{licenceUrl}}</a>, l’ADEME est 
propriétaire des droits de propriété intellectuelle ou détient les droits d’usage sur tous les éléments accessibles sur 
le site, notamment les textes, images, graphismes, logos, icônes, sons, logiciels et marques déposées.
