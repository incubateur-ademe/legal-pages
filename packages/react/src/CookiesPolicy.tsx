...
export const CookiesPolicy = ({
  ...
  //     </p>
  //     <p>
  //       L'ADEME{ifbeta(" et Beta.gouv")} souhaite{ifbeta("nt")} vous informer de manière claire et transparente sur
  //       l'usage des cookies lorsque vous consultez les sites ademe.fr{ifbeta(" et de beta.gouv.fr")}.
  //     </p>
  //     <div className="fr-alert fr-alert--info fr-alert--sm fr-mb-4w">
  //       <p>
  //         À tout moment, en cliquant sur le lien “Gestion des cookies” {cookieConsentButton}, vous pouvez modifier vos
  //         préférences.
  //       </p>
  //     </div>
  ...
  //     <h2>1. Préambule</h2>
  //     <p>
  //       Pour permettre aux internautes de bénéficier des services proposés par le site {siteName} (ci-après le « Site »)
  //       tels que sa consultation, l’optimisation de son utilisation ou sa personnalisation en fonction de l’internaute,
  //       le Site utilise des cookies. Vous pouvez à tout moment désactiver les cookies auxquels vous avez consenti, et ce
  //       gratuitement, à partir des possibilités de désactivation qui vous sont offertes et rappelées ci-avant.
  //     </p>
  //     <h2>2. Définitions</h2>
  //     <p>
  //       Les cookies sont des informations relatives à la navigation de votre terminal (ordinateur, tablette, smartphone,
  //       etc.) sur le Site. Ils sont utilisés pour envoyer des informations à votre navigateur et permettre à ce
  //       navigateur de renvoyer des informations au Site (par exemple un identifiant de session ou le choix d’une
  //       langue).
  //     </p>
  //     <p>
  ...
  //       permettre d’accéder à certaines fonctionnalités du Site, afin que vous puissiez partager des contenus du Site
  //       avec d'autres personnes ou faire connaître à ces autres personnes vos consultations ou vos opinions concernant
  //       un contenu du Site.
  //     </p>
  ...
  //     </p>
  //     <p>
  //       Le réseau social est susceptible de vous identifier grâce à ce bouton, même si vous ne l'avez pas utilisé lors
  //       de votre consultation de notre Site. Ce type de bouton applicatif peut permettre au réseau social concerné de
  //       suivre votre navigation sur notre Site, du seul fait que votre compte au réseau social était activé sur votre
  ...
  //       informations relatives à votre navigation sur notre Site et associées aux données personnelles dont ils
  //       disposent. Nous vous recommandons de consulter les conditions d’utilisation de vos données sur ces réseaux
  //       sociaux pour connaitre les finalités d'utilisation, notamment publicitaires, et les informations de navigation
  //       qu'ils peuvent recueillir grâce à ces boutons applicatifs. Il convient de vous assurer que les conditions
  //       d’utilisation de ces réseaux sociaux peuvent vous permettre d’encadrer et de restreindre l’utilisation de vos
  //       données par ces réseaux sociaux, notamment en paramètrant vos comptes d'utilisation auprès de ces derniers.
  //     </p>
  ...
  //       votre équipement terminal correspondent bien à votre propre utilisation de cet équipement terminal et non à
  //       celle d'un autre utilisateur du même équipement terminal.
  //     </p>
  //     <p>
  ...
  //     <p>
  //       Si des cookies sont mis en place, lors de votre première visite sur le Site, il vous est proposé d’accepter ou
  ...
  //       refus sera déposé sur votre équipement, afin que le Site enregistre l’information selon laquelle vous vous êtes
  //       opposé à l’utilisation de cookies. Si vous supprimez ce cookie de refus, il ne sera plus possible de vous
  ...
  //       traitement de la part des gestionnaires de statistiques {analyticTool.name}.
  //     </p>
  //     <p>
  //       Voir la liste complètes des cookies {analyticTool.name}{" "}
  //       <a target="_blank" rel="nofollow noopener noreferrer" href={analyticTool.cookieListUrl}>
  //         {analyticTool.cookieListUrl}
  //       </a>
  //     </p>
  //     <p>
  ...
  //       pas strictement nécessaires, ils sont soumis ils sont soumis à votre consentement que vous êtes invité à donner
  //       ou à refuser lors de votre première visite.
  //     </p>
  //     <p>
  //       Vous pouvez gérer et modifier à tout moment l’utilisation des cookies suivant les possibilités rappelées
  //       ci-après :
  //     </p>
  //     <ul>
  ...
  //     <p>
  //       <strong>
  //         Attention : l’ADEME{ifbeta(" et Beta.gouv")} vous rappelle{ifbeta("nt")} que la prise en compte de votre refus
  //         d’installer un cookie repose sur le dépôt d’un cookie de refus. Par conséquent, si vous désactivez l’ensemble
  //         des cookies de votre terminal ou si vous changez de terminal, nous ne saurons plus en mesure d’identifier que
  //         vous avez choisi cette option.
  //       </strong>
  //     </p>
  //     <h3>7.3 Module de gestion des cookies</h3>
  //     <p>
  //       Un module vous permet de choisir les cookies que vous souhaitez accepter et ceux que vous souhaitez refuser sur
  //       le Site. À tout moment, en cliquant sur le lien « Gestion des cookies » en bas de page du Site, vous pourrez
  //       accéder au module et modifier vos préférences.
  //     </p>
  ...
  //       <a target="_blank" rel="nofollow noopener noreferrer" href="https://www.youronlinechoices.com/">
  ...
  //       susceptibles d'être utilisés afin d'adapter à la navigation de votre terminal les publicités susceptibles d'y
  //       être affichées.
  //     </p>
  //     <h2>8. Protection des données personnelles</h2>
  //     <p>
  //       Dans le cadre de l’utilisation des cookies telle que décrite dans le présent document, l’ADEME{" "}
  //       {includeBetaGouv ? "et Beta.gouv seront" : "sera"}, en tant que responsable{ifbeta("s")} du traitement,
  //       susceptible{ifbeta("s")} de traiter des données à caractère personnel vous concernant.
  //     </p>
  //     <p>
  //       Les cookies tiers sur le Site dépendent de responsables de traitement externes qui sont susceptibles, si vous
  //       acceptez ces cookies, de traiter des données à caractère personnel vous concernant. L’émission et l’utilisation
  //       de ces cookies par des tiers sont soumises à leur propre politique de protection de la vie privée. Pour plus
  ...
  //       uniquement destinées aux services habilités de l’ADEME{ifbeta(", de Beta.gouv")}, et/ou de l’entreprise
  //       émettrice des cookies tiers.
  //     </p>
  //     <p>
  ...
  //     </p>
  //     <p>
  //       Les données collectées sont, après le décès de la personne, conservées pendant la durée nécessaire pour l’ADEME
  //       {ifbeta(" et Beta.gouv")} de se conformer à {includeBetaGouv ? "leurs" : "ses"} obligations légales et
  //       règlementaires. A l’expiration de ce délai, les données seront effacées, à moins que la personne ne décide
  //       qu’elles soient communiquées à un tiers de son choix, conformément aux dispositions de l’article 85 de la loi
  ...
  //     </p>
  //     <p>
  //       En cas de litige, il est possible de saisir la Commission nationale de l'informatique et des libertés, autorité
