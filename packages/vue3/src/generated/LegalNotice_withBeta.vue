...
defineProps<LegalNoticeProps>();
</script>
<template>
  <h1>Mentions légales</h1>
<p><strong>Mis à jour le {{date}}</strong></p>
<h2>1. Présentation du site</h2>
<p>Il est précisé aux utilisateurs du site {{siteName}} l&#39;identité des différents intervenants dans le cadre de sa
...
<p>Même si le présent est sous une URL “beta.gouv.fr”, la responsabilité, la propriété, et l’édition restent côté ADEME.</p>
...
<p>Le prestataire assurant le stockage direct du site <a href="{{siteUrl}}">{{siteUrl}}</a> est {{siteHost.name}}, dont le
...
<p>L’utilisateur est l’internaute qui navigue, lit, visionne, et utilise le site <a href="{{siteUrl}}">{{siteUrl}}</a> et
ses services.</p>
<h3>1.5. Attribution tierce</h3>
<p>{{element_thirdParties}}</p>
...
<p>Par conséquent, ni l’ADEME, ni l’incubateur de Services Numériques de la DINUM (animateur du programme beta.gouv.fr) ne
peuvent garantir une disponibilité du site et/ou des services, une fiabilité des transmissions et des performances en
termes de temps de réponse ou de qualité. Il n’est prévu aucune assistance technique vis-à-vis de l’utilisateur que ce
soit par des moyens électroniques ou téléphoniques.</p>
...
<p>L’ADEME et l’incubateur de Services Numériques de la DINUM déclinent toute responsabilité quant au contenu des sites
proposés en liens.</p>
...
<a target="_blank" href="{{privacyPolicyUrl}}">{{privacyPolicyUrl}}</a>.</p>
